...
export function Footer() {
  return (
    <footer className="w-full border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-12 md:py-16">
      <div className="container max-w-screen-2xl flex flex-col md:flex-row justify-between gap-8 md:gap-12">
        <div className="flex flex-col space-y-4 md:w-1/3">
          ...
          <div className="pt-4">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Developed & Managed By</h3>
        ...
        <div className="flex flex-col md:w-1/3 text-left md:text-center">
          <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Department Info</h3>
      ...
      <div className="container max-w-screen-2xl mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
