      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-black/5 border border-black/10 rounded-lg focus:outline-none focus:border-indigo-500 transition-colors"
          />
        </div>
        <button className="flex items-center px-4 py-2 bg-black/5 border border-black/10 rounded-lg hover:bg-black/10 transition-colors">
          <Filter className="h-4 w-4 mr-2" /> Filter
        </button>
      </div>

      {/* Logs Table */}
      <div className="glass rounded-xl overflow-hidden border border-black/10">
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-black/5 text-muted-foreground font-medium border-b border-black/10">
              <tr>
                <th className="px-6 py-4 flex items-center cursor-pointer hover:text-foreground transition-colors">
        ...
        <div className="p-4 border-t border-black/10 flex items-center justify-between text-sm text-muted-foreground">
          <span>Showing 1 to 5 of 248 entries</span>
          <div className="flex gap-2">
            <button className="px-3 py-1 bg-black/5 rounded border border-black/10 hover:bg-black/10 disabled:opacity-50" disabled>Previous</button>
            <button className="px-3 py-1 bg-indigo-500/20 text-indigo-400 rounded border border-indigo-500/30">1</button>
            <button className="px-3 py-1 bg-black/5 rounded border border-black/10 hover:bg-black/10">2</button>
            <button className="px-3 py-1 bg-black/5 rounded border border-black/10 hover:bg-black/10">3</button>
            <button className="px-3 py-1 bg-black/5 rounded border border-black/10 hover:bg-black/10">Next</button>
          </div>
        </div>
      </div>
    </div>
