    ...
    <div className="flex-1 w-full p-4 md:p-8 space-y-8 max-w-screen-xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          {/* Security */}
          <section className="glass-card rounded-3xl p-6 md:p-8 border-black/5">
            ...
            <div className="space-y-4 max-w-md">
              <div className="space-y-2">
                ...
                <input type="password" placeholder="••••••••" className="w-full h-10 bg-background/50 border border-black/10 rounded-lg px-4 text-sm focus:border-primary focus:outline-none" />
              </div>
              <div className="space-y-2">
              ...
              <button className="h-10 bg-black/5 hover:bg-black/10 border border-black/10 rounded-lg px-6 text-sm font-semibold transition-colors mt-2">
                Update Password
              </button>
            </div>
          </section>
          ...
          <section className="glass-card rounded-3xl p-6 md:p-8 border-black/5">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between p-4 bg-background/50 border border-black/5 rounded-2xl">
                <div>
        ...
        <div className="space-y-8">
          <section className="glass-card rounded-3xl p-6 border-black/5">
            <h3 className="font-bold mb-4">Appearance</h3>
            <div className="grid grid-cols-3 gap-2">
              <button 
                onClick={() => setTheme('light')}
                className={`flex flex-col items-center gap-2 p-3 rounded-xl border ${theme === 'light' ? 'bg-primary/10 border-primary text-primary' : 'bg-background/50 border-black/5 hover:bg-black/5'}`}
              >
              ...
              <button 
                ...
                className={`flex flex-col items-center gap-2 p-3 rounded-xl border ${theme === 'dark' ? 'bg-primary/10 border-primary text-primary' : 'bg-background/50 border-black/5 hover:bg-black/5'}`}
              >
              ...
              <button 
                ...
                className={`flex flex-col items-center gap-2 p-3 rounded-xl border ${theme === 'system' ? 'bg-primary/10 border-primary text-primary' : 'bg-background/50 border-black/5 hover:bg-black/5'}`}
              >
